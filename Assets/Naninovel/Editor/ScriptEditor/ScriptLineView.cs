...
namespace Naninovel
{
    ...
    {
        public readonly VisualElement Content, Container;
        public readonly Label LineIndexLabel;
        public int LineIndex { get => lineIndex; set => SetIndexLabel(value); }

        protected static ScriptLineView FocusedLine { get; private set; }
        ...
        public ScriptLineView (ScriptLine scriptLine, VisualElement container)
        {
            Container = container;
