...
namespace Naninovel
{
    public class CustomVariablesSettings : ConfigurationSettings<CustomVariablesConfiguration>
    {
        ...
        private static readonly GUIContent valueContent = new GUIContent("Value", "Initial value of the variable.");
        ...
        private void DrawPredefinedVariablesListElement (Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var nameProperty = elementProperty.FindPropertyRelative(nameof(CustomVariableData.Name));
            var valueProperty = elementProperty.FindPropertyRelative(nameof(CustomVariableData.Value));
